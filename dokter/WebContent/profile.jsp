    ...
    <body id="body">
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#body">
						<h1 id="logo">
							<img src="img/logo.png" alt="DoKter">
						</h1>
					</a>
					<!-- /logo -->
                </div>
                ...
                <nav class="collapse navbar-collapse navbar-right" role="navigation">
                    <ul id="nav" class="nav navbar-nav">
                        <li class="current"><a href="indexL.html">Home</a></li>
		...
		<section id="team" class="team"  style="font-size:15px">
          ...
          <div class="col-sm-6" style="text-align:right;">
            ...
            <div class="row mgbt-xs-0"><font color= "#0eb493">
              <label class="col-xs-5 control-label">Diagonostic:</label></font>
          ...
          <div>
			<div class="col-sm-6" style="text-align:right; margin-bottom:15px">
            <div class="row mgbt-xs-0"><font color= "#0eb493">
             <button type="button">Edit Profile</button> </font>
            </div>
          </div>
          </div>
          <div>
            ...
            <div class="row mgbt-xs-0"><font color= "#0eb493">
             <button type="button">Show Previous Visits</button> </font>
            </div>
          </div>
          </div>
